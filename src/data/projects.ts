export const projects = [
  {
    ...
    line: "A multi-brand token system that ships in light and dark.",
    stage: "sage",
  ...
  },
  {
    ...
    index: "02",
    title: "AI Chatbot",
    line: "A usable assistant with visible context, eval, and human control.",
    stage: "blue",
  ...
  },
  {
    ...
    index: "03",
    title: "Scheduling",
    line: "A clear week that removes booking friction at org scale.",
    stage: "terracotta",
  ...
  },
  {
    ...
    index: "04",
    title: "Finance",
    line: "A live ledger that keeps money clear under risk.",
    stage: "brown",
